...
![Scratch editor - making pattern on shirt](images/pattern1.gif){:width="500px"}
--- /task ---
...
![Scratch editor - making pattern on shirt](images/pattern.gif){:width="500px"}
--- /task ---
...
![Scratch editor - making pattern on shirt](images/pattern.png){:width="500px"}
--- /task ---
